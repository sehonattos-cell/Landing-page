    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden"
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div style={anim(800)} className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="https://wa.me/6285175203850" target="_blank" rel="noreferrer"
        ...
        {[
          {
            ...
            cta: "Book via WhatsApp", ctaHref: "https://wa.me/6285175203850",
...
function Contact() {
  const socials = [
    { label:"WhatsApp", href:"https://wa.me/6285175203850", bg:"#25d366",
...
function FloatingWA() {
  return (
    <a href="https://wa.me/6285175203850" target="_blank" rel="noreferrer" aria-label="Chat WhatsApp"
